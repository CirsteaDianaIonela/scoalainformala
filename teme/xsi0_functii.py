...
def rezultat():
    ...
    elif (lista[0] == lista[1] == lista[2] and lista[0] != "-" and lista[0] == '[0]') \
         or (lista[3] == lista[4] == lista[5] and lista[3] != "-" and lista[3] == "[0]") \
         or (lista[6] == lista[7] == lista[8] and lista[6] != "-" and lista[6] == "[0]") \
         or (lista[0] == lista[4] == lista[8] and lista[0] != "-" and lista[0] == "[0]") \
         or (lista[2] == lista[4] == lista[6] and lista[2] != "-" and lista[2] == "[0]") \
         or (lista[0] == lista[3] == lista[6] and lista[0] != "-" and lista[0] == "[0]") \
         or lista[2] == lista[5] == lista[8] and lista[2] != "-" and lista[2] == "[0]" \
         or (lista[1] == lista[4] == lista[7] and lista[1] != "-" and lista[1] == "[0]"):
            print('Ai castigat, [0]')
    else:
        print('Remiza')
