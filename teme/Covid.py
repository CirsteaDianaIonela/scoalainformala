...
for zi in range(20, 27, 1):
    ...
    # print(df) #m-am blocat aici, imi returneaza informatiile pentru toate zilele, numai ca le returneaza una sub alta
    df.to_csv("Resultate-covid.csv") #ciudat ca aici imi duce in csv doar ultima zi, desi mai sus la print vedeam toate zilele
