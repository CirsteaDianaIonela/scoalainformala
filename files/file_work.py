#de exemplu mutarea informatiilor dintr-un fisier in altul
# with #deschide un fisier

# with open("fisier.txt","w") as file: #in aceasta sintaxa numesc fisierul file
